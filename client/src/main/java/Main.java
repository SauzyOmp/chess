...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(EscapeSequences.SET_TEXT_COLOR_BLUE + EscapeSequences.SET_TEXT_BOLD + 
            "♕ Welcome to Chess!" + EscapeSequences.RESET_TEXT_COLOR);
        ...
        System.out.println(EscapeSequences.SET_TEXT_COLOR_WHITE + "  " + EscapeSequences.SET_TEXT_COLOR_GREEN + 
            ...
            " - Show detailed help for current state");
        System.out.println(EscapeSequences.SET_TEXT_COLOR_WHITE + "  " + EscapeSequences.SET_TEXT_COLOR_GREEN + 
